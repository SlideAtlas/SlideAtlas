# CLAUDE.md — SlideAtlas 프로젝트 메모리 v2.4
...
*최종 업데이트: 2026-05-27 v2.4*
*주요 변경: 핵심 포지셔닝 "땡시 대비, 집에서 한국어로" 추가. 사용자 지위 체계(학생/조교/교수) 확정 및 섹션 21 전면 재편. 교수 수업 페이지(섹션 21-9) 신규 추가. DB 스키마에 courses/course_weeks/course_week_slides/course_assistants 테이블 추가. 콘텐츠 현황 출장 결과 반영(Happy Science Mallen Zhang, Yulin Jessy). Go Criteria 10번 항목 추가. v2.3 기존 내용 전체 유지.*
