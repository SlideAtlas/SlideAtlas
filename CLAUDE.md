# CLAUDE.md — SlideAtlas 프로젝트 메모리 v3.23
...
| D35 | TIFF 변환 파이프라인 실가동 점검·리허설 | 134종 입고(2026-06 다음주) 전 소규모 리허설(SVS→COG→S3→타일). 타일서버 systemd 미등록(INFRA_CHECKLIST F-1)·미니맵/썸네일 S3 사전생성(D7) 점검. | 🔴 입고 전 | CEO/Lead |
