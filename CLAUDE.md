# CLAUDE.md — SlideAtlas 프로젝트 메모리 v3.14
...
- 내부 QA(a)스코프격리 (b)과목격리(비구독 403) (c)수식주입 방어 (d)집계 과목별 산출→롤업 (+)빈데이터 graceful — pytest 196(P3 15 + 외부검증반영 13). **포털 3탭(P1·P2·P3) 완성.** 본 수정분 인접 경로 한정 Codex+Gemini 재검증 1라운드 → CEO 승인.
