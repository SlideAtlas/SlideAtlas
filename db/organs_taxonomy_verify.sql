...
\echo '=== [1] organs 테이블 생성 확인 (1행 = 성공) ==='
-- [1] organs 테이블이 실제로 생성됐는지 (1행 반환 = 성공)
SELECT table_name
FROM information_schema.tables
WHERE table_name = 'organs';

\echo '=== [2] organs 컬럼 구조 (organ_code PK / name_ko NOT NULL / organ_system 등) ==='
...
\echo '=== [7] 미매핑 슬라이드 수 (organ 있고 organ_code NULL — 138종 적재 후 0 수렴) ==='
...
\echo '=== [8] 미매핑 실제 organ 값 목록 (백필/시드 보강 대상) ==='
